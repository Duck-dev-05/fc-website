...
export default function SignInButton({ provider }: SignInButtonProps) {
  ...
  const getProviderColor = (name: string) => {
    switch (name) {
      ...
      case "Twitter":
        return "hover:bg-sky-50 text-sky-600";
      case "GitHub":
  ...
  return (
    <button
      ...
      className={`flex w-full items-center justify-center gap-3 rounded-md bg-white px-4 py-2.5 text-sm font-medium shadow-sm ring-1 ring-inset ring-gray-300 transition-colors duration-200 ${getProviderColor(provider.name)}`}
    >
